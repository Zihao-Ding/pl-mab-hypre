...
extern "C"
{
#include "kissat_mab_hypre/src/parse.h"
}

int
kissatMABHyPreTerminate(void* solverPtr)
{
	KissatMABHyPreSolver* pkissat = (KissatMABHyPreSolver*)solverPtr;
...
{
	KissatMABHyPreSolver* painless_kissat = (KissatMABHyPreSolver*)painless_interface;
...
KissatMABHyPreSolver::KissatMABHyPreSolver(int id, const std::shared_ptr<ClauseDatabase>& clauseDB)
	...
	, clausesToAdd(__globalParameters__.defaultClauseBufferSize)
{
	...
	initializeTypeId<KissatMABHyPreSolver>();
}

KissatMABHyPreSolver::~KissatMABHyPreSolver()
{
...
void
KissatMABHyPreSolver::loadFormula(const char* filename)
{
...
unsigned int
KissatMABHyPreSolver::getVariablesCount()
{
...
int
KissatMABHyPreSolver::getDivisionVariable()
{
...
void
KissatMABHyPreSolver::setPhase(const unsigned int var, const bool phase)
{
...
void
KissatMABHyPreSolver::bumpVariableActivity(const int var, const int times)
{
...
void
KissatMABHyPreSolver::setSolverInterrupt()
{
	stopSolver = true;
...
void
KissatMABHyPreSolver::unsetSolverInterrupt()
{
	stopSolver = false;
}
...
SatResult
KissatMABHyPreSolver::solve(const std::vector<int>& cube)
{
	if (!this->isInitialized()) {
...
void
KissatMABHyPreSolver::addClause(ClauseExchangePtr clause)
{
...
void
KissatMABHyPreSolver::addClauses(const std::vector<ClauseExchangePtr>& clauses)
{
...
void
KissatMABHyPreSolver::addInitialClauses(const std::vector<simpleClause>& clauses, unsigned int nbVars)
{
...
void
KissatMABHyPreSolver::addInitialClauses(const lit_t* literals, unsigned int clsCount, unsigned int nbVars)
{
	kissat_reserve(this->solver, nbVars);
	this->originalVars = nbVars;
...
bool
KissatMABHyPreSolver::importClause(const ClauseExchangePtr& clause)
{
...
void
KissatMABHyPreSolver::importClauses(const std::vector<ClauseExchangePtr>& clauses)
{
...
void
KissatMABHyPreSolver::printStatistics()
{
...
std::vector<int>
KissatMABHyPreSolver::getFinalAnalysis()
{
...
std::vector<int>
KissatMABHyPreSolver::getSatAssumptions()
{
	std::vector<int> outCls;
	LOGERROR("NOT IMPLEMENTED");
	return outCls;
...
void
KissatMABHyPreSolver::initKissatOptions()
{
...
void
KissatMABHyPreSolver::diversify(const SeedGenerator& getSeed)
{
	if (this->isInitialized()) {
...
void
KissatMABHyPreSolver::printWinningLog()
{
...
void
KissatMABHyPreSolver::computeFamily()
{
