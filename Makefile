...
KISSATMABHYPREEVOLVE_BUILD := $(SOLVERS_DIR)/kissat_mab_hypre_evolve/build
...
DEPENDENCIES := $(MINISAT_BUILD)/libminisat.a \
				...
				$(KISSATMABHYPREEVOLVE_BUILD)/libkissat_mab_hypre_evolve.a
...
LIBS := -l:liblgl.a -L$(LINGELING_BUILD) \
		...
		-l:libkissat_mab_hypre_evolve.a -L$(KISSATMABHYPREEVOLVE_BUILD) \
...
# ==========================
.PHONY: minisat glucose lingeling kissat kissat_mab kissat_inc kissat_gaspi yalsat cadical maple m4ri tassat kissat_mab_hypre_evolve

solvers: minisat glucose lingeling kissat kissat_mab kissat_inc kissat_gaspi yalsat cadical maple tassat kissat_mab_hypre_evolve
...
kissat_mab_hypre: $(KISSATMABHYPREEVOLVE_BUILD)/kissat_mab_hypre_evolve.a
...
$(KISSATMABHYPREEVOLVE_BUILD)/libkissat_mab_hypre_evolve.a:
	cd $(SOLVERS_DIR)/kissat_mab_hypre_evolve && bash ./configure --no-proofs
	$(MAKE) -C $(SOLVERS_DIR)/kissat_mab_hypre_evolve
...
cleansolvers:
	...
	$(MAKE) clean -C $(SOLVERS_DIR)/kissat_mab_hypre_evolve
