...
#include "solvers/CDCL/KissatMABHyPreEvolveFzSolver.hpp"

// loadFormula includes
extern "C"
{
#include "kissat_mab_hypre_evolve_fz/src/parse.h"
}

int
kissatMABHyPreTerminate(void* solverPtr)
{
	KissatMABHyPreEvolveSolver* pkissat = (KissatMABHyPreEvolveSolver*)solverPtr;
	return pkissat->stopSolver;
}

char
kissatMABHyPreImportClause(void* painless_interface, kissat* internal_solver)
{
	KissatMABHyPreEvolveSolver* painless_kissat = (KissatMABHyPreEvolveSolver*)painless_interface;
...
char
kissatMABHyPreExportClause(void* painless_interface, kissat* internal_solver)
{
	KissatMABHyPreEvolveSolver* painless_kissat = (KissatMABHyPreEvolveSolver*)painless_interface;
...
KissatMABHyPreEvolveSolver::KissatMABHyPreEvolveSolver(int id, const std::shared_ptr<ClauseDatabase>& clauseDB)
	...
	, clausesToAdd(__globalParameters__.defaultClauseBufferSize)
{
	...
	kissat_set_export_call(solver, kissatMABHyPreExportClause);
	kissat_set_import_call(solver, kissatMABHyPreImportClause);
	...
	initializeTypeId<KissatMABHyPreEvolveSolver>();
}

KissatMABHyPreEvolveSolver::~KissatMABHyPreEvolveSolver()
{
...
void
KissatMABHyPreEvolveSolver::loadFormula(const char* filename)
{
...
unsigned int
KissatMABHyPreEvolveSolver::getVariablesCount()
{
...
int
KissatMABHyPreEvolveSolver::getDivisionVariable()
{
...
void
KissatMABHyPreEvolveSolver::setPhase(const unsigned int var, const bool phase)
{
...
void
KissatMABHyPreEvolveSolver::bumpVariableActivity(const int var, const int times)
{
...
void
KissatMABHyPreEvolveSolver::setSolverInterrupt()
{
	stopSolver = true;
...
void
KissatMABHyPreEvolveSolver::unsetSolverInterrupt()
{
	stopSolver = false;
}
...
SatResult
KissatMABHyPreEvolveSolver::solve(const std::vector<int>& cube)
{
	if (!this->isInitialized()) {
...
void
KissatMABHyPreEvolveSolver::addClause(ClauseExchangePtr clause)
{
...
void
KissatMABHyPreEvolveSolver::addClauses(const std::vector<ClauseExchangePtr>& clauses)
{
...
void
KissatMABHyPreEvolveSolver::addInitialClauses(const std::vector<simpleClause>& clauses, unsigned int nbVars)
{
...
void
KissatMABHyPreEvolveSolver::addInitialClauses(const lit_t* literals, unsigned int clsCount, unsigned int nbVars)
{
	kissat_reserve(this->solver, nbVars);
	this->originalVars = nbVars;
...
bool
KissatMABHyPreEvolveSolver::importClause(const ClauseExchangePtr& clause)
{
...
void
KissatMABHyPreEvolveSolver::importClauses(const std::vector<ClauseExchangePtr>& clauses)
{
...
void
KissatMABHyPreEvolveSolver::printStatistics()
{
...
std::vector<int>
KissatMABHyPreEvolveSolver::getModel()
{
...
std::vector<int>
KissatMABHyPreEvolveSolver::getFinalAnalysis()
{
...
std::vector<int>
KissatMABHyPreEvolveSolver::getSatAssumptions()
{
	std::vector<int> outCls;
	LOGERROR("NOT IMPLEMENTED");
	return outCls;
...
void
KissatMABHyPreEvolveSolver::initKissatOptions()
{
...
void
KissatMABHyPreEvolveSolver::diversify(const SeedGenerator& getSeed)
{
	if (this->isInitialized()) {
...
void
KissatMABHyPreEvolveSolver::printWinningLog()
{
...
void
KissatMABHyPreEvolveSolver::computeFamily()
{
