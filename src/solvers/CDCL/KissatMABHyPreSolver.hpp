...
#define KISSAT_MAB_HYPRE_

// Kissat includes
extern "C"
{
#include <kissat_mab_hypre/src/kissat.h>
}

/// Instance of a Kissat MAB Hybrid Presolve solver
/// @ingroup solving_cdcl
class KissatMABHyPreSolver : public SolverCdclInterface
{
  public:
	/// Constructor.
	KissatMABHyPreSolver(int id, const std::shared_ptr<ClauseDatabase>& clauseDB);

	/// Destructor.
	virtual ~KissatMABHyPreSolver();
