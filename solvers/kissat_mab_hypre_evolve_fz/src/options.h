...
#define OPTIONS \
  ...
  OPTION (caps, 0, 0, 1, "conflict-aware propagation scheduling") \
  ...
  OPTION (witnessmaxvar, INT_MAX, 0, INT_MAX, "only print witness up to this variable") \
  ...
  OPTION (qsar, 0, 0, 1, "quantitative stability analysis restart") \
  OPTION (awvsids, 0, 0, 1, "enable activity-weighted VSIDS") \
  OPTION (uars, 0, 0, 1, "enable utility-based adaptive reduction scheduling") \
